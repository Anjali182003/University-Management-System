...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent() {
        ...
        labelroll = new JLabel("2010DMTCSE" + first4);
        labelroll.setBounds(200,200,200,30);
        labelroll.setFont(new Font("serif",Font.BOLD,18));
        add(labelroll);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            try {
                ...
                String query = "insert into student values('"+name+"','"+fname+"','"+roll+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+class10+"','"+class12+"','"+aadhar+"','"+course+"','"+branch+"')";
